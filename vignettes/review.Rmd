...
In the presence of network spillovers, it is generally impossible to define identifiable causal estimands without introducing some restrictions.
...
\end{align*}
where $\mathcal{E}_i$ denotes the set of unit $j \neq i$ who belong to unit $i$'s $K$-neighborhood.
